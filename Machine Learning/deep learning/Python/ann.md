...
1. Installing Theano library
2. Installing Tensorflow library
3. Installing Keras
...
10. Initialising the ANN
11. Adding the input layer and the first hidden layer
12. Adding the second hidden layer
13. Adding the output layer
14. Compiling the ANN
15. Fitting the ANN to the Training set
